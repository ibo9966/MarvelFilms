...
import com.example.avengers.databinding.ItemWithPosterBinding
import com.example.avengers.databinding.ItemWithoutPosterBinding
...
class MainAdapter (private val mList:List<DataItem>)
    ...
    inner class ItemWithPosterViewHolder(val binding: ItemWithPosterBinding)
    ...
    inner class ItemWithoutPosterViewHolder(val binding: ItemWithoutPosterBinding)
        :RecyclerView.ViewHolder(binding.root){
